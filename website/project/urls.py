...
from museum.api import EntryResource, AuthorResource, LicenseResource, ExperimentResource,\
    CollectionResource, KeywordResource, SourceResource, ExhibitionResource
